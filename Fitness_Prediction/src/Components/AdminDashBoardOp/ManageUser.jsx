...
const ViewUsers = () => {
  ...
  const filteredUsers = users
    ...
    .filter((user) => {
      ...
      if (filterStatus === "Approve") return user.status === "Approve";
      if (filterStatus === "Reject") return user.status === "Reject";
  ...
  return (
    <div className="container mt-4 cont p-3 position-relative">
      ...
      <div className="d-flex justify-content-center mb-4 flex-wrap gap-2">
        ...
        <button
          className={`btn ${filterStatus === "Approve" ? "btn-success" : "btn-outline-success"}`}
          onClick={() => setFilterStatus("Approve")}
        >
          Approved
        </button>
        <button
          className={`btn ${filterStatus === "Reject" ? "btn-danger" : "btn-outline-danger"}`}
